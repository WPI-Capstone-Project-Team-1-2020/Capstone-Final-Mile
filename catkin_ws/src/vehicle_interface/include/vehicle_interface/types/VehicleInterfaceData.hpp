...
public:
    ...
    bool                                       getTakeoffLandGoalReached() const noexcept {return m_takeoff_land_reached;}
    ...
    void setTakeoffLandGoalReached(const bool val)                     noexcept {m_takeoff_land_reached = val;}
...
private:
    ...
    bool                                m_takeoff_land_reached{false}; /// True if takeoff or landing goal was reached
