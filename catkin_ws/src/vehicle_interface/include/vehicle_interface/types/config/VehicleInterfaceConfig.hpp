...
public:
        ...
        m_angular_config{pnh, "angular"}
    {
        ...
        pnh.getParam("takeoff_land_reached_topic",  m_takeoff_land_reached_topic);
    ...
    const std::string& getTakeoffLandReachedTopic() const noexcept {return m_takeoff_land_reached_topic;}
...
private:
    ...
    std::string m_takeoff_land_reached_topic{""}; ///< Takeoff/landing goal reached topic
