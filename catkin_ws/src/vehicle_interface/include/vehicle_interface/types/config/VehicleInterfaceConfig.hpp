...
public:
        ...
        m_angular_config{pnh, "angular"}
    {
        ...
        pnh.getParam("takeoff_reached_topic",  m_takeoff_reached_topic);
        pnh.getParam("landing_reached_topic",  m_landing_reached_topic);
        pnh.getParam("trajectory_topic",       m_traj_topic);
        pnh.getParam("takeoff_land_topic",     m_takeoff_land_topic);
    ...
    const std::string& getTakeoffReachedTopic() const noexcept {return m_takeoff_reached_topic;}
    const std::string& getLandingReachedTopic() const noexcept {return m_landing_reached_topic;}
...
private:
    ...
    std::string m_takeoff_reached_topic{""}; ///< Takeoff goal reached topic
    std::string m_landing_reached_topic{""}; ///< Landing goal reached topic
